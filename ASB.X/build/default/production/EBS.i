...
# 54 "./mcc_generated_files/pwm2_16bit.h"
...
# 54 "./mcc_generated_files/pwm2_16bit.h" 2
...
# 1001 "./mcc_generated_files/adc.h"
...
# 1037 "./mcc_generated_files/adc.h"
...
# 1073 "./mcc_generated_files/adc.h"
...
# 1145 "./mcc_generated_files/adc.h"
...
# 1181 "./mcc_generated_files/adc.h"
...
# 911 "./mcc_generated_files/tmr2.h"
 void TMR2_SetInterruptHandler(void (* InterruptHandler)(void));
# 929 "./mcc_generated_files/tmr2.h"
extern void (*TMR2_InterruptHandler)(void);
# 947 "./mcc_generated_files/tmr2.h"
...
void EBS_CheckUP_Routine (void)
{
    ...
    if ( ucCheck == 6 )
    {
        if ( ( ANALOG_GetVoltage(2) >= NPRES_min ) && ( ANALOG_GetVoltage(3) >= NPRES_min ) && ( ANALOG_GetVoltage(0) <= NPRES_max ) && ( ANALOG_GetVoltage(1) <= NPRES_max ) )
        {
            ucCheck = 7;
        }
        else
    ...
    if ( ucCheck == 7 )
    {
        if ( ( ANALOG_GetVoltage(4) <= NPRES_atm ) && ( ANALOG_GetVoltage(5) <= NPRES_atm ) )
        {
            ucCheck++;
        }
        else
    ...
    if ( ucCheck == 8 )
    {
        ...
        if ( ( ANALOG_GetVoltage(0) >= HDRPRES_min ) && ( ANALOG_GetVoltage(1) >= HDRPRES_min ) && ( ANALOG_GetVoltage(0) <= HDRPRES_max ) && ( ANALOG_GetVoltage(1) <= HDRPRES_max ))
        {
            ucCheck = 9;
        }
        else
    ...
    if ( ucCheck == 12 )
    {
        ...
        if ( ( ANALOG_GetVoltage(0) >= HDRPRES_braking ) && ( ANALOG_GetVoltage(0) >= HDRPRES_braking )
                && ( ANALOG_GetVoltage(4) >= NPRES_braking ) && ( ANALOG_GetVoltage(5) >= NPRES_atm ))
        {
            ucCheck = 13;
        }
        else
    ...
    {
        DELAY_milliseconds(1000);
        if ( ( PORTAbits.RA0 >= HDRPRES_max ) & ( PORTAbits.RA1 >= HDRPRES_max ) )
        {
            ucCheck = 15;
        }
        else
