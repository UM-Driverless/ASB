...
void GPIO_Init (void)
{
    ...
    do { ANSELAbits.ANSELA0 = 1; } while(0);
    do { ANSELAbits.ANSELA1 = 1; } while(0);
    do { ANSELCbits.ANSELC7 = 1; } while(0);
    do { ANSELCbits.ANSELC6 = 1; } while(0);
    do { ANSELCbits.ANSELC4 = 1; } while(0);
...
void GPIO_BrakePedalAtRest (void)
{
    ucPedalPos = PORTAbits.RA5;
    if ( ucPedalPos == 1 )
    {

        ucPICHDRPRES1min = ANALOG_GetVoltage(0);
        ucPICHDRPRES2min = ANALOG_GetVoltage(1);
